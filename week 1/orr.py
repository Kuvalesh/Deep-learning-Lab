...
Original file is located at
    https://colab.research.google.com/drive/1YF9C0oRy6HglRZU5VpdkJ8COfAgBexaP
"""
...
# Training the McCulloch-Pitts Neuron for 4 epochs with a threshold of 0.5 and learning rate of 0.2
train_mcculloch_pitts_neuron(inputs, target_output, initial_weights, threshold=0.5, learning_rate=0.3, epochs=4)
